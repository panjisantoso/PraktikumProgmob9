...
public class MyDocumentAdapter extends RecyclerView.Adapter<MyDocumentAdapter.MyViewHolder> {
    ...
    public MyDocumentAdapter(Context context, List<Document> documentsList) {
    ...
    public MyDocumentAdapter.MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        return new MyDocumentAdapter.MyViewHolder(rootView);
    }
    ...
    private void deleteDocument(String idDocument, final int position){
        ApiClient.getClient()
                .create(ApiService.class)
